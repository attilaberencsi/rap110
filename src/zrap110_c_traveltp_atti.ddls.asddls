...
define root view entity ZRAP110_C_TRAVELTP_ATTI
  ...
  as projection on ZRAP110_R_TRAVELTP_ATTI
{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_TRAV_ELEM_ATTI'
  ...
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZRAP110_C_BOOKINGTP_ATTI,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
