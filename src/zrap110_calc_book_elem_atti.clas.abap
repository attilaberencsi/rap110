  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_days_to_flight
        IMPORTING is_original_data TYPE ZRAP110_C_BookingTP_ATTI
        RETURNING VALUE(result)    TYPE ZRAP110_C_BookingTP_ATTI.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      ...
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'INITIALDAYSTOFLIGHT'   OR 'REMAININGDAYSTOFLIGHT'
          ...
          DATA lt_book_original_data TYPE STANDARD TABLE OF ZRAP110_C_BookingTP_ATTI WITH DEFAULT KEY.
          ...
          LOOP AT lt_book_original_data ASSIGNING FIELD-SYMBOL(<fs_book_original_data>).
            <fs_book_original_data> = zrap110_calc_book_elem_atti=>calculate_days_to_flight( <fs_book_original_data> ).
          ENDLOOP.
