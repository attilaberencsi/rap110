...
define view entity ZRAP110_C_BOOKINGTP_ATTI
  as projection on ZRAP110_R_BOOKINGTP_ATTI
{
  ...
  key     BookingID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_BOOK_ELEM_ATTI'
  ...
  virtual DaysToFlightIndicator  : abap.int1,
          ...
          // public associations
          _Travel : redirected to parent ZRAP110_C_TRAVELTP_ATTI,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
