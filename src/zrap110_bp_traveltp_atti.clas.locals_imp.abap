...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD recalcTotalPrice.
    ...
    LOOP AT travels ASSIGNING FIELD-SYMBOL(<travel>).
      ...
      LOOP AT amounts_per_currencycode INTO DATA(amount_per_currencycode).
        ...
        ELSE.
          zcl_currency_conv_amdp=>convert_currency(
             EXPORTING
  ...
  METHOD setInitialTravelValues.
    ...
    DATA: update TYPE TABLE FOR UPDATE zrap110_r_traveltp_ATTI\\Travel.
  ...
  METHOD adjust_numbers.
    ...
    IF mapped-booking IS NOT INITIAL.
      ...
      LOOP AT mapped-booking INTO DATA(mapped_booking) GROUP BY mapped_booking-TravelID.
        SELECT MAX( booking_id ) FROM zrap110_abookatt WHERE travel_id = @mapped_booking-TravelID INTO @DATA(max_booking_id) .
