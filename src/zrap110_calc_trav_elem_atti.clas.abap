  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_trav_status_ind
        IMPORTING is_original_data TYPE ZRAP110_C_TravelTP_ATTI
        RETURNING VALUE(result)    TYPE ZRAP110_C_TravelTP_ATTI.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'OVERALLSTATUSINDICATOR'.
          ...
          DATA lt_trav_original_data TYPE STANDARD TABLE OF ZRAP110_C_TravelTP_ATTI WITH DEFAULT KEY.
          ...
          LOOP AT lt_trav_original_data ASSIGNING FIELD-SYMBOL(<fs_trav_original_data>).
            ...
            <fs_trav_original_data> = zrap110_calc_trav_elem_atti=>calculate_trav_status_ind( <fs_trav_original_data> ).
